<?php
namespace CFPAY_peyment_addon\payssion;
use CFPAY_peyment_addon\payssion as CFPAY_payssion;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_payssion\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='payssion';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('payssion','payssion','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(payssion)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\payssion\Cfpaymentaddon_index();
}
?>