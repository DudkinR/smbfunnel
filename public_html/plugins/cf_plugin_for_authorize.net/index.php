<?php
namespace CFPAY_peyment_addon\authorizenet;
use CFPAY_peyment_addon\authorizenet as CFPAY_authorizenet;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_authorizenet\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='authorize.net';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Authorize.net','Authorize.net','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(Authorize.net)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\authorizenet\Cfpaymentaddon_index();
}
?>