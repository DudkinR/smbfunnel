                    ...
                    <div class="card pnl visual-pnl">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group" v-for="(val,index) in selected_method_data.fields" data-toggle="tooltip" v-bind:title="val.title">
                                ...
                                <div v-else-if="val.type!==undefined && val.type=='url'">
                                    <div class="input-group mb-3">                                        
                                        <input type="text" class="form-control" v-bind:placeholder="val.placeholder" v-model="val.value" id="logo_url">
                                        <div class="input-group-append">
                                            <button class="btn btn-success" type="button" v-on:click="gtlogourl('#logo_url', false)">Get URL</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div v-else-if="val.type!==undefined && val.type=='text'">
