...
let cfpay_payment_methods=new Vue({
    ...
    methods: {
       ...
       gtlogourl:function(selector, html ){
       
        console.log(this.selected_method_data['fields'].logo_url);

        cfSquareGetIcon(selector, html)
       },
        saveSetup:function(){
            this.err="";
            this.success_msg="";
            ...
            form_data.append('cfpay_payment_storeName',storeName);
            form_data.append('cfpay_payment_logo_url',logo_url);
            req.send(form_data);
        }
    }
});
...
function cfSquareGetIcon(selector, html) {
    let url;
        try {            
