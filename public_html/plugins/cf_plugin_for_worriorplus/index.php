<?php
namespace CFPAY_peyment_addon\warriorplus;
use CFPAY_peyment_addon\warriorplus as CFPAY_warriorplus;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_warriorplus\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='warriorplus';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('WarriorPlus','WarriorPlus','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(WarriorPlus)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\warriorplus\Cfpaymentaddon_index();
}
?>