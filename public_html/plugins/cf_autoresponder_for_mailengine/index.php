<?php
namespace CFAuto_autoresponder_addon\mailengine ;
use CFAuto_autoresponder_addon\mailengine as CFAUTO_mailengine;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_mailengine\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='mailengine';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Mailengine','Mailengine','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(Mailengine)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\mailengine\Cfautoresaddon_index();
}
?>