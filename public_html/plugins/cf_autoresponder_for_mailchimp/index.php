<?php
namespace CFAuto_autoresponder_addon\mailchimp ;
use CFAuto_autoresponder_addon\mailchimp as CFAUTO_mailchimp;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_mailchimp\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='mailchimp';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Mailchimp','Mailchimp','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(Mailchimp)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\mailchimp\Cfautoresaddon_index();
}
?>