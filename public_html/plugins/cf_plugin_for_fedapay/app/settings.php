<?php
if(isset($_POST['cffedapaydelsetup']))
{
    $this->deleteSetup($_POST['cffedapaydelsetup']);
}
?>
                ...
                <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
                                <tr><th>#</th><th>Title</th><th>Tax</th><th>Action</th><th>Added On</th></tr>
                            </thead>
                            ...
                            <!-- keyword search -->   
                                ...
                                for($i=0; $i<count($all_data); $i++)
                                {
                                    ...
                                    <td><a href='index.php?page=cfpay_setting_".$this->method."&id=".$data->id."'><button class='btn unstyled-button' data-bs-toggle='tooltip' title='Edit'><i class='text-primary fas fa-edit'></i></button></a></td>
                                    <td><form action='' method='POST'><button type='submit' class='btn unstyled-button' data-bs-toggle='tooltip' title='Delete' name='cffedapaydelsetup' value='".$data->id."'><i class='text-danger fas fa-trash'></i></button></form></td>
                                    </tr></table>";

                                    echo "<tr>
                                    <td>".$count_hash."</td>
                                    <td><a href='index.php?page=cfpay_setting&id=".$data->id."'>".$data->title."</a></td>
                                    <td>".$data->tax."%</td>
