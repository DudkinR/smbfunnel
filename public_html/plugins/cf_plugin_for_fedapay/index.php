...
use CFPAY_peyment_addon\fedapay as CFPAY_fedapay;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_fedapay\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='fedapay';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Fedapay','Fedapay','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(Fedapay)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\fedapay\Cfpaymentaddon_index();
}
?>