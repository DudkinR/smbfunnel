...
<div class="row page-titles mb-4">
                    ...
                    <div class="d-flex justify-content-end align-items-center">Create, edit and manage your Aweber
                Autoresponder</div>
                    </div>
</div>
    ...
    <div class="row">
        <div class="col-sm-12" v-if="open_setup">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="card-body">
                <div class="alert alert-info"><span onclick="(function(){window.open('http://cloudfunnels.in/membership/api/aweber/create','_blank','location=yes,height=570,width=520,scrollbars=yes,status=yes');})()" class="text-primary" style="cursor: pointer;"><strong>
                         click Here </strong></span> to generate Aweber credentials                      </div>
