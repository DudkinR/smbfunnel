<?php
namespace CFAuto_autoresponder_addon\aweber ;
use CFAuto_autoresponder_addon\aweber as CFAUTO_aweber;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_aweber\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='aweber';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Aweber','Aweber','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(Aweber)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\aweber\Cfautoresaddon_index();
}
?>