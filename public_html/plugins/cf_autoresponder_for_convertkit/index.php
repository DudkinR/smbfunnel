<?php
namespace CFAuto_autoresponder_addon\convertkit ;
use CFAuto_autoresponder_addon\convertkit as CFAUTO_convertkit;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_convertkit\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='convertkit';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('ConvertKit','ConvertKit','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(ConvertKit)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\convertkit\Cfautoresaddon_index();
}
?>