...
<div class="row page-titles mb-4">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor" id="commoncontainerid">Paykickstart</h4>
                    </div>
					...
					<div class="mb-3">
						<div class="input-group input-group-sm">
							<div class="input-group-prepend ">
							 ...
							 <input type="text" class="form-control form-control-sm" placeholder="<?php w('Search with title and method name'); ?>" onkeyup="searchPaymentMethods(this.value)">
						</div>
					</div>
					</div>
                </div>
