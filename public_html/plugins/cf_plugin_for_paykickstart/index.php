<?php
namespace CFPAY_peyment_addon\paykickstart ;
use CFPAY_peyment_addon\paykickstart as CFPAY_paykickstart;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_paykickstart\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='paykickstart';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Paykickstart','Paykickstart','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(Paykickstart)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\paykickstart\Cfpaymentaddon_index();
}
?>