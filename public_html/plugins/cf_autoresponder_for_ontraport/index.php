<?php
namespace CFAuto_autoresponder_addon\ontraport ;
use CFAuto_autoresponder_addon\ontraport as CFAUTO_ontraport;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_ontraport\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='ontraport';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Ontraport','Ontraport','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(Ontraport)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\ontraport\Cfautoresaddon_index();
}
?>