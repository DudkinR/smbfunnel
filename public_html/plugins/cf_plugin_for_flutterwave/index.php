<?php
namespace CFPAY_peyment_addon\flutterwave;
use CFPAY_peyment_addon\flutterwave as CFPAY_flutterwave;
...
if(!class_exists('Cfpaymentaddon_index'))
{
    ...
    class Cfpaymentaddon_index extends CFPAY_flutterwave\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='flutterwave';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Flutterwave','Flutterwave','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(Flutterwave)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\flutterwave\Cfpaymentaddon_index();
}
?>