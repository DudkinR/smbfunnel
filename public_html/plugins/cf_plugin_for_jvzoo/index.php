<?php
namespace CFPAY_peyment_addon\jvzoo;
use CFPAY_peyment_addon\jvzoo as CFPAY_jvzoo;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_jvzoo\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='jvzoo';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('JVZoo','JVZoo','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(JVZoo)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\jvzoo\Cfpaymentaddon_index();
}
?>