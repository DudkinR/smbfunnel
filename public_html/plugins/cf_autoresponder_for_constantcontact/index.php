<?php
namespace CFAuto_autoresponder_addon\constantcont ;
use CFAuto_autoresponder_addon\constantcont as CFAUTO_constantcont;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_constantcont\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='constantcont';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Constant Contact','Constant Contact','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(Constant Contact)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\constantcont\Cfautoresaddon_index();
}
?>