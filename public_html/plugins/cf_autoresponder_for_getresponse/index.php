<?php
namespace CFAuto_autoresponder_addon\getresponse ;
use CFAuto_autoresponder_addon\getresponse as CFAUTO_getresponse;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_getresponse\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='getresponse';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Getresponse','Getresponse','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(Getresponse)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\getresponse\Cfautoresaddon_index();
}
?>