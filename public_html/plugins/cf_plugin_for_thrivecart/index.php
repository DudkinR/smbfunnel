<?php
namespace CFPAY_peyment_addon\thrivecart ;
use CFPAY_peyment_addon\thrivecart as CFPAY_thrivecart;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_thrivecart\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='thrivecart';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('ThriveCart','Thrivecart','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(Thrivecart)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\thrivecart\Cfpaymentaddon_index();
}
?>