...
use CFPAY_peyment_addon\paypal as CFPAY_paypal;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_paypal\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='paypal';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Paypal','Paypal','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(Paypal)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\paypal\Cfpaymentaddon_index();
}
?>