<?php
namespace CFPAY_peyment_addon\clickbank ;
use CFPAY_peyment_addon\clickbank as CFPAY_clickbank;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_clickbank\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='clickbank';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('ClickBank','ClickBank','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(ClickBank)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\clickbank\Cfpaymentaddon_index();
}
?>