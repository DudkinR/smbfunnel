...
class Cfpay_processor
{
    ...
    function doSaveUpdateSetting( $data)
    {
        ...
        if( $run->num_rows > 0)
        {
            ...
            $run1 = $mysqli->query("INSERT INTO `$table` (`setting`,`stripe_id`,`email_subject`,`email_content`,`card_html`,`return_url`,`email_days`) VALUES ('$add_setting', $id,'$subject','$body','$card_html','$return_url','$email_days')");
            if($run1)
            {
