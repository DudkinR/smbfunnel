  function CFquizoMangeInputs(){
    ...
    this.createINP=function(name='',placeholder='',title='',required=1, type='text'){
      ...
      let inp_html=`<div class="row">
        ...
        let main_container=document.querySelectorAll("#cfquizo_input_container")[0];
        ...
        inp.addEventListener('click',function(){
          document.querySelectorAll("#cfquizo_input_container div[lvl]").forEach(doc=>{
        ...
        inp_up.addEventListener('click',function(eve){
          ...
          if(current_lvl>1)
          {
            let up_doc=document.querySelectorAll(`#cfquizo_input_container div[lvl="${current_lvl-1}"`)[0];
            //console.log(up_doc);
            document.querySelectorAll(`#cfquizo_input_container`)[0].insertBefore(inp,up_doc);
        ...
        inp_down.addEventListener('click',function(eve){
          ...
          {
            let down_doc=document.querySelectorAll(`#cfquizo_input_container div[lvl="${current_lvl+1}"`)[0];
            document.querySelectorAll(`#cfquizo_input_container`)[0].insertBefore(down_doc,inp);
        ...
        inp_close.addEventListener('click',function(){
          let inp=this.inp;
          let doc=document.querySelectorAll(`#cfquizo_input_container`)[0];
          doc.removeChild(inp);
          let count=0;
    ...
    this.getInputs=function(){
      let docs=document.querySelectorAll("#cfquizo_input_container div[lvl]");
      let inputs=[];
