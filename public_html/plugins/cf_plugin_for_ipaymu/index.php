<?php
namespace CFPAY_peyment_addon\iPaymu;
use CFPAY_peyment_addon\iPaymu as CFPAY_iPaymu;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_iPaymu\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='iPaymu';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('iPaymu','iPaymu','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(iPaymu)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\iPaymu\Cfpaymentaddon_index();
}
?>