<?php
if(isset($_POST['cfpaymongodelsetup']))
{
    $this->deleteSetup($_POST['cfpaymongodelsetup']);
}
?>
                        ...
                        <table class="table table-striped">
                            ...
                            <!-- keyword search -->   
                                ...
                                for($i=0; $i<count($all_data); $i++)
                                {
                                    ...
                                    <td><form action='' method='POST'><button type='submit' class='btn unstyled-button' data-bs-toggle='tooltip' title='Delete' name='cfpaymongodelsetup' value='".$data->id."'><i class='text-danger fas fa-trash'></i></button></form></td>
                                    </tr></table>";
