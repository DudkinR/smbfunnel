<?php
namespace CFAuto_autoresponder_addon\mailerlite ;
use CFAuto_autoresponder_addon\mailerlite as CFAUTO_mailerlite;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_mailerlite\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='mailerlite';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Mailerlite','Mailerlite','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(Mailerlite)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\mailerlite\Cfautoresaddon_index();
}
?>