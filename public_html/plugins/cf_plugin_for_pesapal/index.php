...
use CFPAY_peyment_addon\pesapal as CFPAY_pesapal;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_pesapal\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='pesapal';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Pesapal','Pesapal','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(Pesapal)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\pesapal\Cfpaymentaddon_index();
}
?>