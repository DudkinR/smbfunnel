<?php
if(isset($_POST['cfpesapaldelsetup']))
{
    $this->deleteSetup($_POST['cfpesapaldelsetup']);
}
?>
                        ...
                        <table class="table table-striped">
                            ...
                            <!-- keyword search -->   
                                ...
                                for($i=0; $i<count($all_data); $i++)
                                {
                                    ...
                                    <td><form action='' method='POST'><button type='submit' class='btn unstyled-button' data-toggle='tooltip' title='Delete' name='cfpesapaldelsetup' value='".$data->id."'><i class='text-danger fas fa-trash'></i></button></form></td>
                                    </tr></table>";
