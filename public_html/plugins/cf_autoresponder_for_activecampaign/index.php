...
if(!class_exists('Cfautoresaddon_activecampaign_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_activecampaign_index extends Cfautores_activecampaign_process
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='activecampaign';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Activecampaign','Activecampaign','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(Activecampaign)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new Cfautoresaddon_activecampaign_index();
}
?>