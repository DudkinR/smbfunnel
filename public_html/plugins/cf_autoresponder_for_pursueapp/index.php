...
use CFAuto_autoresponder_addon\pursueapp as CFAUTO_pursueapp;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_pursueapp\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='pursueapp';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Pursueapp','Pursueapp','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(Pursueapp)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\pursueapp\Cfautoresaddon_index();
}
?>