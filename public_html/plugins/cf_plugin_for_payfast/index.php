<?php
namespace CFPAY_peyment_addon\midtrans;
use CFPAY_peyment_addon\midtrans as CFPAY_midtrans;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_midtrans\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='midtrans';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Midtrans','Midtrans','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(Midtrans)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\midtrans\Cfpaymentaddon_index();
}
?>