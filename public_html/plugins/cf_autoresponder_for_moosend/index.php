<?php
namespace CFAuto_autoresponder_addon\moosend ;
use CFAuto_autoresponder_addon\moosend as CFAUTO_moosend;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_moosend\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='moosend';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Moosend','Moosend','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(Moosend)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\moosend\Cfautoresaddon_index();
}
?>