<?php
namespace CFAuto_autoresponder_addon\mailwizz ;
use CFAuto_autoresponder_addon\mailwizz as CFAUTO_mailwizz;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_mailwizz\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='mailwizz';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('MailWizz','MailWizz','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(MailWizz)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\mailwizz\Cfautoresaddon_index();
}
?>