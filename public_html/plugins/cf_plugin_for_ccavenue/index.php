<?php
namespace CFPAY_peyment_addon\ccavenue;
use CFPAY_peyment_addon\ccavenue as CFPAY_ccavenue;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_ccavenue\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        var $method='ccavenue';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('CCAvenue','CCAvenue','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(CCAvenue)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\ccavenue\Cfpaymentaddon_index();
}
?>