...
<div class="row page-titles mb-4">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor" id="commoncontainerid">CCAvenue</h4>
                    </div>
                ...
                <div class="row">
					...
					<div class="mb-3">
						<div class="input-group input-group-sm">
							<div class="input-group-prepend ">
							 ...
							 <input type="text" class="form-control form-control-sm" placeholder="<?php w('Search with title, method name'); ?>" onkeyup="searchPaymentMethods(this.value)">
						</div>
					</div>
					</div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
                                <tr><th>#</th><th>Title</th><th>Tax</th><th>Added On</th><th>Action</th></tr>
                            </thead>
                            ...
                            <!-- keyword search -->   
                                ...
                                for($i=0; $i<count($all_data); $i++)
                                {
                                    ...
                                    <td><form action='' method='POST'><button type='submit' class='btn unstyled-button' data-bs-toggle='tooltip' title='Delete' name='cfpaydelsetup' value='".$data->id."'><i class='text-danger fas fa-trash'></i></button></form></td>
                                    </tr></table>";
