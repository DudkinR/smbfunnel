...
<div class="row page-titles mb-4">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor" id="commoncontainerid">CF Automizy Autoresponders </h4>
                    </div>
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">Create, edit and manage your Autoresponders</div>
                    </div>
</div>
                ...
                <div class="row">
                        ...
                        <table class="table table-striped">
                            ...
                            <!-- keyword search -->   
                                ...
                                for($i=0; $i<count($all_data); $i++)
                                {
                                    ...
                                    <td><a href='index.php?page=cfautores_setting&id=".$data->id."'><button class='btn unstyled-button' data-bs-toggle='tooltip' title='Edit'><i class='text-primary fas fa-edit'></i></button></a></td>
                                    ...
                                    echo "<tr>
                                    <td>".$count_hash."</td>
                                    <td><a href='index.php?page=cfautores_setting&id=".$data->id."'>".$data->autoresponder."</a></td>
                    ...
                    <div class="row mt-4">
                        <div class="col text-end">
                            <?php
                            $next_page_url="index.php?page=cfautores_setups&page_count";
                            echo createPager($total,$next_page_url,$page_count);
                            ?>
                        </div>
                        <div class="col text-end">
                            <a href="index.php?page=cfautores_setting"><button class="btn theme-button"><i class="fas fa-pencil-alt"></i>&nbsp;Create New</button></a>
                        </div>
                    </div>
