import CFautores_methods from './methods.js';

let cfautores_autoresponder_methods=new Vue({
    el: "#cfautores_autoresponder_methods",
    mounted:function(){
    ...
    methods: {
        ...
        saveSetup:function(){
            ...
            form_data.append('action','cfautores_savcredentials');
...
export default cfautores_autoresponder_methods;