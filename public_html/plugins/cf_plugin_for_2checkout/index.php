<?php
namespace CFPAY_peyment_addon\two_checkout;
use CFPAY_peyment_addon\two_checkout as CFPAY_2checkout;

if(!class_exists('Cfpaymentaddon_index'))
{
    require_once('app/process.php');
    class Cfpaymentaddon_index extends CFPAY_2checkout\Cfpay_processor
    {
        var $pref='cfpay';
        var $config=false;
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('2Checkout','2Checkout','cfpay_setups_'.$this->method,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfpay_setups_'.$this->method,'Manage Setup(2Checkout)','Create New','cfpay_setting_'.$this->method,function(){
    ...
    new \CFPAY_peyment_addon\two_checkout\Cfpaymentaddon_index();
}
?>