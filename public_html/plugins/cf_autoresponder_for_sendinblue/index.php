...
use CFAuto_autoresponder_addon\sendinblue as CFAUTO_sendinblue;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_sendinblue\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='sendinblue';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Sendinblue','Sendinblue','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(Sendinblue)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\sendinblue\Cfautoresaddon_index();
}
?>