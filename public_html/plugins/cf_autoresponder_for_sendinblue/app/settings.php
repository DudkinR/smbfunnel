...
<div class="row page-titles mb-4">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor" id="commoncontainerid">SendinBlue</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">Create, edit and manage your Sendinblue Autoresponder</div>
                    </div>
</div>
					...
					<div class="mb-3">
						<div class="input-group input-group-sm">
							<div class="input-group-prepend ">
							 ...
							 <input type="text" class="form-control form-control-sm" placeholder="<?php w('Search with title'); ?>" onkeyup="searchPaymentMethods(this.value)">
						</div>
					</div>
					</div>
                </div>
