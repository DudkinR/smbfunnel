<?php
namespace CFAuto_autoresponder_addon\sendiio ;
use CFAuto_autoresponder_addon\sendiio as CFAUTO_sendiio;

if(!class_exists('Cfautoresaddon_index'))
{
    require_once('app/process.php');
    class Cfautoresaddon_index extends CFAUTO_sendiio\Cfautores_processor
    {
        var $pref='cfautores';
        var $config=false;
        var $autores='sendiio';
        ...
        function createMenuandSubmenu()
        {
            ...
            add_action('admin_menu',function(){
                ...
                add_menu_page('Sendiio','Sendiio','cfautores_setups_'.$this->autores,array($this,'createMenu'),$logo_url,'All Setups');
                add_submenu_page('cfautores_setups_'.$this->autores,'Manage Setup(Sendiio)','Create New','cfautores_setting_'.$this->autores,function(){
    ...
    new \CFAuto_autoresponder_addon\sendiio\Cfautoresaddon_index();
}
?>